window.onload = function(){ 
    ...
    console.log("Employees above 30 years old:");
    ...
    let metaIndex = companies.indexOf('Meta');
    companies[metaIndex] = { name: 'Meta', employees: metaEmployees }; 
    ...
    let appleIndex = companies.indexOf('Apple');
    companies[appleIndex] = { name: 'Apple', employees: appleEmployees };
    ...
    let microsoftIndex = companies.indexOf('Microsoft');
    companies[microsoftIndex] = { name: 'Microsoft', employees: microsoftEmployees };
    // 7 firmy vlozte do pole 
    let companiesWithEmployees = companies;
